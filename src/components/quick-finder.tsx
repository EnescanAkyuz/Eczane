        ...
        <div className="fixed inset-0 z-[10000] flex items-end justify-center bg-zinc-900/60 p-3 backdrop-blur-sm sm:items-center">
          <div className="w-full max-w-md animate-fade-in rounded-2xl border border-zinc-200 bg-white p-5 shadow-2xl sm:rounded-3xl">
            ...
            <div className="mt-5 grid grid-cols-2 gap-2">
              ...
              <button
                className="flex h-12 items-center justify-center gap-2 rounded-xl bg-emerald-600 text-sm font-bold text-white transition hover:bg-emerald-500 active:scale-[0.97] disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={isBusy}
                onClick={() => {
                  // iOS Safari Bug Cozumu: Modal'i API'den yanit gelene kadar kapatma.
                  // Eger DOM'dan kaldirilirsa Safari native prompt'u iptal eder.
                  runGpsSearch().finally(() => {
